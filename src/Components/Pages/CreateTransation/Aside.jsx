...
const Aside = () => {
    ...
    return (
        <>
            <aside className={classNames('z-[2] fixed bottom-0 bg-white w-[100vw] flex justify-around items-center shadow-shadow md:shadow-xl md:block md:p-6 text-blue-800 transition-all',
                {
                    "md:relative md:w-[70px] md:h-[100vh] lg:w-[250px]": !aside,
                    "w-[230px] md:h-[100vh] md:block md:relative": aside,
                }
            )}>
                <FaChevronCircleRight onClick={setAside} className={classNames("hidden text-2xl text-blue-800 cursor-pointer absolute right-[-10px] top-4 md:block lg:hidden", {

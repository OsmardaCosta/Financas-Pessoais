        ...
        <div className='min-h-[100vh] bg-zinc-100'>
            <header className='z-[1] relative h-[390px] bg-fixed bg-cover bg-home flex justify-between px-5 py-2 overflow-x-hidden'>
                ...
                <div onClick={toggleDrop} className='cursor-pointer relative'>
                    <MdMenu className='text-white text-2xl font-bold md:hidden' />
                ...
                <div className='hidden md:flex flex-col '>
                    <ul className='flex gap-3 text-white items-center'>
                        ...
                        <li className=''>
                            <button 
                                onClick={StartHome} 
                                className='bg-white text-black px-4 py-1 rounded-full font-medium select-none md:text-xl'>
                                Comece
                            </button>
                        </li>
                    </ul>
            ...
            <main className='relative px-8'> 
                <button className='z-[30] absolute -top-[40px] right-[50%] translate-x-14 px-6 py-2 bg-white text-black rounded-md -mt-[10px] shadow-md font-medium text-lg md:hidden'>Comece</button>
                ...
                <div className=' mt-6 grid grid-cols-1 md:grid-cols-3 md:gap-4'>
                    <div className='bg-white shadow-xl rounded-md mb-4 p-3'>
                ...
                <div className='mb-5 grid items-center grid-cols-1 md:grid-cols-2'>
                    ...
                    <div className='overflow-y-auto mt-7 md:m-0'>
                        <Chart/>
                    </div>
                </div>
            </main>
